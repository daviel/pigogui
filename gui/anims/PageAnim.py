...
ANIM_PAGE_SLIDE_OUT_LEFT.set_custom_exec_cb(ANIM_PAGE_SLIDE_OUT_LEFT.anim_func)
ANIM_PAGE_SLIDE_OUT_LEFT.anim_cb = anim_func

ANIM_PAGE_SLIDE_OUT_RIGHT = GenericAnim()
ANIM_PAGE_SLIDE_OUT_RIGHT.init()
...
ANIM_PAGE_SLIDE_OUT_RIGHT.set_custom_exec_cb(ANIM_PAGE_SLIDE_OUT_RIGHT.anim_func)
ANIM_PAGE_SLIDE_OUT_RIGHT.anim_cb = anim_func

ANIM_PAGE_SLIDE_IN_LEFT = GenericAnim()
ANIM_PAGE_SLIDE_IN_LEFT.init()
...
ANIM_PAGE_SLIDE_IN_LEFT.set_custom_exec_cb(ANIM_PAGE_SLIDE_IN_LEFT.anim_func)
ANIM_PAGE_SLIDE_IN_LEFT.anim_cb = anim_func

ANIM_PAGE_SLIDE_IN_RIGHT = GenericAnim()
ANIM_PAGE_SLIDE_IN_RIGHT.init()
...
ANIM_PAGE_SLIDE_IN_RIGHT.set_custom_exec_cb(ANIM_PAGE_SLIDE_IN_RIGHT.anim_func)
